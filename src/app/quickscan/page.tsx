      ...
      <main>
        ...
        <section className="bg-[var(--color-navy)] pt-40 pb-24">
          <div className="max-w-6xl mx-auto px-6">
            <p className="text-[var(--color-gold)] text-xs tracking-[0.3em] uppercase mb-6">Volledig gratis</p>
            <h1 className="text-white text-5xl md:text-6xl font-serif font-semibold max-w-3xl leading-tight mb-8">
              Gratis quickscan: ontdek jouw 5 grootste online kansen
            </h1>
            <p className="text-white/70 text-lg max-w-xl leading-relaxed">
              In 48 uur ontvang je een persoonlijke analyse van jouw online zichtbaarheid. Inclusief 5 concrete winsten die je direct kunt benutten. Volledig gratis, zonder verplichtingen.
            </p>
          </div>
        </section>
        {/* Wat je krijgt */}
        ...
        <section className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-[var(--color-gold)] text-xs tracking-[0.3em] uppercase mb-4">Gratis en vrijblijvend</p>
              <h2 className="text-3xl md:text-4xl font-serif text-[var(--color-navy)] mb-6">
                Ontvang jouw gratis quickscan binnen 48 uur
              </h2>
            ...
            <div className="bg-[var(--color-cream)] p-10">
              <h3 className="text-[var(--color-navy)] font-serif text-xl mb-8">Vraag jouw gratis scan aan</h3>
